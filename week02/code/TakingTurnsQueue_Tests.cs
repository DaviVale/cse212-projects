...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: // The queue is returning the last person added instead of the first person added.
    ...
    // Defect(s) Found: No defect found. The correct exception is thrown when the queue is empty.
